...
class Report:
    ...
    def _get_temp_vol_pot(self, statistics_file):
        ...
        Delegates to qc._get_temp_vol_pot.
        ...
        """
        return qc._get_temp_vol_pot(statistics_file)

    def _equilibration_analysis(self):
        """Plot equilibration data: potential energy, temperature and volume.
        Delegates to qc.equilibration_analysis.
        """
        qc.equilibration_analysis(self.statistics, self.out_path)
